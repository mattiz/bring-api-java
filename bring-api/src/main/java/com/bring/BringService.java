...
import com.bring.exceptions.CouldNotLoadBringConnectionAdapterException;
import com.bring.exceptions.RequestFailedException;
import com.bring.shippingguide.dao.ShippingGuideDao;
...
import com.bring.tracking.dao.TrackingDao;
...
public class BringService {
    ...
    protected BringConnection detectAndLoadConnectionAdapter(String clientIdentifier) {
        ...
        try {
            bringConnection = loadConnectionAdapter("com.bring.connection.HttpClient4Adapter", clientIdentifier);
        }
        catch (CouldNotLoadBringConnectionAdapterException e1) {
            try {
                bringConnection = loadConnectionAdapter("com.bring.connection.HttpClient3Adapter", clientIdentifier);
            }
